...
window.CARDS = [
  ...
  { cat:'occurrence', cl:'c-hydro',
    ...
    n:'Ruby and sapphire are impure Al₂O₃ (with Cr and Co impurities respectively).' },
  ...
  { cat:'occurrence', cl:'c-hydro',
    ...
    n:'Iron pyrites NOT used for extraction — produces SO₂ (polluting). Oxide ores preferred.' },
  ...
  { cat:'occurrence', cl:'c-hydro',
    ...
    bs:'',
    n:'CuFeS₂ is the most important ore commercially.' },
  ...
  { cat:'occurrence', cl:'c-hydro',
    ...
    bs:'',
    n:'Zinc blende (ZnS) is the most common ore.' },
  ...
  { cat:'occurrence', cl:'c-hydro',
    ...
    bs:'',
    n:'"Gangue" = unwanted earthly impurities associated with the ore.' },
  ...
  { cat:'concentration', cl:'c-misc',
    ...
    n:'Invented by observation: copper compounds floated in soapsuds while washing miners\' clothes (Mrs. Carrie Everson).' },
  ...
  { cat:'concentration', cl:'c-misc',
    ...
    n:'SiO₂ dissolves as sodium silicate and stays in solution. Other impurities (Fe₂O₃, TiO₂) are left behind.' },
  ...
  { cat:'concentration', cl:'c-misc',
    ...
    n:'More reactive Zn displaces less reactive Au/Ag from cyanide complex.' },
  ...
  { cat:'extraction', cl:'c-heat',
    ...
    bs:'',
    n:'Calcination → carbonates, hydrated oxides. Roasting → sulphides. Both convert ore to oxide for reduction.' },
  ...
  { cat:'thermodynamics', cl:'c-redox',
    ...
    n:'Limitations: (1) Only thermodynamic — doesn\'t tell about kinetics/rate. (2) Assumes equilibrium — not always true in commercial processes.' },
  ...
  { cat:'thermodynamics', cl:'c-redox',
    ...
    bs:'',
    n:'CO curve going down is why coke becomes a better reducing agent at higher temperatures.' },
  ...
  { cat:'thermodynamics', cl:'c-redox',
    ...
    bs:'',
    n:'Below 1073 K: CO₂ is the preferred product of carbon oxidation. Above 1073 K: CO preferred → more useful reductant.' },
  ...
  { cat:'applications', cl:'c-redox',
    ...
    n:'Pig iron (from blast furnace): ~4% C + impurities S, P, Si, Mn.' },
  ...
  { cat:'applications', cl:'c-redox',
    ...
    bs:'',
    n:'Wrought iron: lowest C content, most malleable. Used for chains, anchors, agricultural implements.' },
  ...
  { cat:'applications', cl:'c-redox',
    ...
    n:'Blister copper = impure; must be refined electrolytically.' },
  ...
  { cat:'applications', cl:'c-redox',
    ...
    n:'India was first country to master zinc distillation (downward distillation technique, 5th–6th BCE, Zawar, Rajasthan).' },
  ...
  { cat:'applications', cl:'c-redox',
    ...
    n:'Cryolite role: lowers MP of Al₂O₃ from ~2000°C to ~950°C and makes it conducting.' },
  ...
  { cat:'refining', cl:'c-misc',
    ...
    n:'Recovery of precious metals from anode mud often pays for the refining cost.' },
  ...
  { cat:'refining', cl:'c-misc',
    ...
    n:'Two requirements for vapour phase refining: (1) metal forms volatile compound; (2) compound easily decomposable.' },
