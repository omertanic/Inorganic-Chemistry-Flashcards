...
window.CARDS = [
  ...
  { cat:'solubility', cl:'c-an-sol',
    ...
    bs:'PbCl₂, PbBr₂, PbI₂ all dissolve in hot water', n:'' , imp:true },
  ...
  { cat:'co3-tests', cl:'c-an-co3',
    ...
    bs:'CaCO₃ dissolves due to soluble Ca(HCO₃)₂', n:'' , imp:true },
  ...
  { cat:'co3-tests', cl:'c-an-co3',
    ...
    bs:'Note: SO₂ also gives lime water test (milky)', n:'' , imp:true },
  ...
  { cat:'co3-tests', cl:'c-an-co3',
    ...
    bs:'CO₃²⁻ is alkaline enough to turn HPh pink; HCO₃⁻ is not', n:'' , imp:true },
  ...
  { cat:'s2-tests', cl:'c-an-s2',
    ...
    fs:'Test (ii) — Imp',
    b:'Pb²⁺(aq) + H₂S(g) → PbS↓ + H⁺\nBlack precipitate',
    bs:'Lead acetate paper turns black in H₂S', n:'' , imp:true },
  ...
  { cat:'s2-tests', cl:'c-an-s2',
    ...
    bs:'S²⁻ gives purple directly; H₂S needs NaOH first', n:'' , imp:true },
  ...
  { cat:'no2-tests', cl:'c-an-no2',
    ...
    bs:'I⁻ reduces NO₂; I₂ formed turns starch blue', n:'' , imp:true },
  ...
  { cat:'no2-tests', cl:'c-an-no2',
    ...
    bs:'Red azo dye formation = positive test for NO₂⁻', n:'' , imp:true },
  ...
  { cat:'conc-h2so4', cl:'c-an-conc',
    ...
    bs:'Cl⁻ → HCl only; Br⁻ → Br₂; I⁻ → I₂', n:'' , imp:true },
  ...
  { cat:'cl-tests', cl:'c-an-cl',
    ...
    bs:'MnO₂ is O.A.; Cl⁻ is R.A.', n:'' , imp:true },
  ...
  { cat:'cl-tests', cl:'c-an-cl',
    ...
    bs:'AgCl + aq.NH₃ → [Ag(NH₃)₂]Cl(aq) soluble complex', n:'' , imp:true },
  ...
  { cat:'cl-tests', cl:'c-an-cl',
    ...
    bs:'Note: AgCl, PbCl₂, SnCl₂ do NOT give chromyl chloride test', n:'' , imp:true },
  ...
  { cat:'br-tests', cl:'c-an-br',
    ...
    bs:'AgBr insoluble in dil. NH₃; AgCl soluble', n:'' , imp:true },
  ...
  { cat:'br-tests', cl:'c-an-br',
    ...
    bs:'F₂ > Cl₂ > Br₂ > I₂ (decreasing oxidising power)', n:'' , imp:true },
  ...
  { cat:'i-tests', cl:'c-an-i',
    ...
    bs:'AgI only dissolves in KCN and hypo — most insoluble of AgX', n:'' , imp:true },
  ...
  { cat:'i-tests', cl:'c-an-i',
    ...
    bs:'Br layer = brown; I layer = violet — key distinction', n:'' , imp:true },
  ...
  { cat:'i-tests', cl:'c-an-i',
    ...
    bs:'AgCl easiest to dissolve; AgI hardest', n:'' , imp:true },
  ...
  { cat:'no3-tests', cl:'c-an-no3',
    ...
    bs:'Brown ring at interface = positive test for NO₃⁻', n:'' , imp:true },
  ...
  { cat:'c2o4-tests', cl:'c-an-ox',
    ...
    bs:'C₂O₄²⁻ gives both CO and CO₂; formate gives only CO', n:'' , imp:true },
  ...
  { cat:'c2o4-tests', cl:'c-an-ox',
    ...
    bs:'Oxalate reduces permanganate — classic redox', n:'' , imp:true },
  ...
  { cat:'so4-tests', cl:'c-an-so4',
    ...
    bs:'Insoluble in dil. acids = confirms SO₄²⁻', n:'' , imp:true },
  ...
  { cat:'so4-tests', cl:'c-an-so4',
    ...
    bs:'Acid wash confirms SO₄²⁻ by eliminating CO₃²⁻, SO₃²⁻ etc.', n:'' , imp:true },
